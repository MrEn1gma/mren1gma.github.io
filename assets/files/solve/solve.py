...
solver.add(f[0]
     ...
     + f[7]
     + 3 * f[14]
     + 2 * (f[23] + f[24] + f[17] + f[21] + f[12] + f[18]) == 2024)
solver.add( f[0]
     + f[22]
     + f[23]
     + f[26]
...
solver.add( f[12]
     ...
     + f[3]
     + f[13]
     + 2 * (f[22] + f[14] + f[10] + f[19] + f[27]) == 1561 )
...
solver.add( f[22]
     ...
     + f[27]
     + 3 * (f[20] + f[7])
     + 2 * (f[18] + f[4] + f[19] + f[25] + f[13]) == 2184 )
solver.add( f[24]
     + f[17]
     + f[21]
     + f[10]
